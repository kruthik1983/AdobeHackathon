...
def create_json_file(title: str, outline, input_filename: str, output_dir: str):
    """
    ...
    Args:
        ...
        input_filename: The base name of the input PDF file.
    ...
    base_name = os.path.splitext(input_filename)
    ...
    try:
        ...
        print(f"Error writing JSON file for {input_filename}: {e}")import json
import os
