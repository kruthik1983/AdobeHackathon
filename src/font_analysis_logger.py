...
def log_font_styles(feature_lines: list, output_dir: str, filename_prefix: str = "font_styles_report"):
    ...
    for line in feature_lines:
        style_key = (
            round(line["font_size"], 1), # Rounded for easier grouping
            line["font_name"],
            line["is_bold"],
            line["is_italic"],
            line["is_centered"],
            round(line["x0"], 0), # Also include x0 for indentation patterns
            line["font_color"] # Include font color in style key
        )
    ...
    try:
        with open(output_path, 'w', newline='', encoding='utf-8') as csvfile:
            ...
            # Sort for better readability in the CSV
            ...
            for style_key, data in sorted_styles:
                writer.writerow({
                    ...
                    'Font_Color': style_key[6], # New field
